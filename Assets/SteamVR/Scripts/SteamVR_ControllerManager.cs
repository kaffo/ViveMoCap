...
{
	public GameObject left, right, leftfoot, rightfoot;
    ...
    uint leftfootIndex = OpenVR.k_unTrackedDeviceIndexInvalid;
    uint rightfootIndex = OpenVR.k_unTrackedDeviceIndexInvalid;
    ...
    public void UpdateTargets()
	{
		...
		var objects = new GameObject[4 + additional];
		indices = new uint[4 + additional];
		objects[0] = right;
		indices[0] = OpenVR.k_unTrackedDeviceIndexInvalid;
		objects[1] = left;
		indices[1] = OpenVR.k_unTrackedDeviceIndexInvalid;
        objects[2] = rightfoot;
        indices[2] = OpenVR.k_unTrackedDeviceIndexInvalid;
        objects[3] = leftfoot;
        indices[3] = OpenVR.k_unTrackedDeviceIndexInvalid;
        for (int i = 0; i < additional; i++)
		{
			objects[4 + i] = this.objects[i];
			indices[4 + i] = OpenVR.k_unTrackedDeviceIndexInvalid;
		}
	...
	static string[] labels = { "left", "right", "leftfoot", "rightfoot" };
